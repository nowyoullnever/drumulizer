...
export const translations = {
  ko: {
    ...
    'app.noSample': '샘플 없음',
    'app.analysisPending': '수동 슬라이스 편집',
    ...
    'analysis.disabled':
      '분석용 mono 데이터는 zero-crossing 보정에만 사용합니다. FFT, onset, HPSS, slicing 자동화는 v0.3.0에서 실행하지 않습니다.',
  ...
  en: {
    ...
    'app.analysisPending': 'Manual slice editing',
    ...
    'analysis.disabled':
      'Analysis mono data is used only for zero-crossing assist. FFT, onset, HPSS, and automatic slicing do not run in v0.3.0.',
